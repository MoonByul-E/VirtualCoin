...
namespace Client
{
    public partial class pwSearchForm : MetroFramework.Forms.MetroForm
    {
        ...
        private void pwSearchForm_Load(object sender, EventArgs e)
        {
